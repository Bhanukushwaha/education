class BlogsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @blog.update(blog_params)
        format.html { redirect_to define_admin_routes({resourceName: 'Blog', objectId: @blog.id}), notice: 'Blog was successfully updated.' }
  ...
  private
    ...
    def blog_params
      params.require(:blog).permit(:title, :description, :image, :user_id, :image_file_name, :image_content_type, :image_file_size, :image_updated_at)
    end
end
